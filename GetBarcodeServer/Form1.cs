    ...
    public partial class Form1 : Form
    {
       ...
       public enum SoundType
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            LoadUI();
            this.Text = "Get Barcode Server,Ver:" + Application.ProductVersion + "(20210705)";
        ...
        {
            string str = DateTime.Now.ToString("yyyyMMddHHmmss") + ".LOG";
                ...
                if ((input != "") & Regex.IsMatch(input, "^[A-Z0-9]+$"))
                {
                    if (UseWeb == "1")
                    {
                        ...
                        if (result.ToLower ().Contains ("not exist"))
                        {
                            ...
                            RecordMsg(input + " is not exist in SFCS.");
                            return;
                        }
                    }
